...
class groceries(baseFunctions):
    ...
    def __init__(self, fileCSV, path2TextFile):
        ...
        if self.wantToKnowCheapestItem == "Yes" or "Yes": 
        ...
        if self.wantToKnowMostExpensiveItem == "Yes" or "Yes": 
        ...
        print(f"Your total is ${self.totalPrice}") 
    ...
    def checkoutDesk(self):
        ...
        Returns: 
        float: the total price that the customer would have to pay
        """
